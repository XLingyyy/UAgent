...
| D13 / 15A                          | Clean build/install/load and authoritative manifest identity.                                                                            | DISPATCHED         | Historical attempts are source-invalidated. Current implementation commit `4b6e2fa35ad999882dd3b50d697ab7cb36a1552e` exists and the clean restart is dispatched.                                                                                                                                                           | Use that commit with final build/manifest tooling and verify installed == loaded == manifest. |
...
| D16                                | Repository documentation and final delivery.                                                                                             | IN_PROGRESS        | Historical states, accepted source checkpoints through Resume 10, cleanup closure and deferred live work are synchronized.                                                                                                                                                                                                 | Fresh 15A-15C live evidence and final closeout remain outstanding.                            |
...
- D13 / 15A: `DISPATCHED` from `4b6e2fa35ad999882dd3b50d697ab7cb36a1552e`.
...
- Recovery continues in the newly dispatched clean-checkout compatibility task
  ...
  `4b6e2fa35ad999882dd3b50d697ab7cb36a1552e`. Real mutation remains gated until
