...
commit `af483722d08212374f67bfc756fa34b79e195e8c`. Real mutation remains gated
...
| D13 / 15A                          | Clean build/install/load and authoritative manifest identity.                                                                            | DISPATCHED         | Historical attempts are source-invalidated. Current implementation commit `af483722d08212374f67bfc756fa34b79e195e8c` exists and the clean restart is dispatched.                                                                                                                                                           | Use that commit with final build/manifest tooling and verify installed == loaded == manifest. |
...
- D13 / 15A: `DISPATCHED` from `af483722d08212374f67bfc756fa34b79e195e8c`.
...
- Recovery continues in the newly dispatched clean-checkout compatibility task
  ...
  `af483722d08212374f67bfc756fa34b79e195e8c`. Real mutation remains gated until
