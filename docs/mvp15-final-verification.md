...
- Acceptance: `BLOCKED`.
- Current fresh product-UI mutation smoke: not run. C14 was read-only product-adapter Connect/Discover only.
...
## C14/C14A Implementation and Read-only Ledger - 2026-07-19
