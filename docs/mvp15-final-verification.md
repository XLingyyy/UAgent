...
## Resume 15 accepted interim source checkpoint — 2026-08-22
...
`DISPATCHED` from `f5b514c7ac78a47c233bfdbae9e3f2d70840a08f`, D14/15B waits on
...
`f5b514c7ac78a47c233bfdbae9e3f2d70840a08f`, and G16 is `PARTIAL`. The
`b1c4e4a...` /
