...
`3331e220f53f528c7cc98e61efc927428d4eaeca`. Resume 15's ninth interim
checkpoint pins renderer restart to the verified ready-generation snapshot when
concurrent discovery advances the mutable global generation. The retained clean
`e50022d...` lineage passed release, ExactSix `1 / 1 / 0 / 0` and fixed 15A
`3 / 3 / 0 / 0`; rendered 15B then failed closed at the predecessor-generation
binding. All artifacts from that lineage retain causal value only. Fresh
supervisor verification passed final tooling `32 / 32`, workspace tests `1685`
with three existing skips, source identity `20 / 20`, Rust `198 / 198`, lint,
typecheck and build. D13 / 15A is redispatched from `3331e220...`; final Task
...
`PARTIAL`. D13 / 15A is `DISPATCHED` from `3331e220...`; D14 / 15B waits on 15A and D15 / 15C
...
`3331e220f53f528c7cc98e61efc927428d4eaeca`. The fifth interim checkpoint
...
`e50022ddecf0c6a19ceb4d78dc8eb54b5e118f0b`; the current ninth checkpoint is
`3331e220f53f528c7cc98e61efc927428d4eaeca`. A separate clean-checkout rebuild
from the ninth checkpoint restarts G16 and D13 / 15A.
...
`3331e220f53f528c7cc98e61efc927428d4eaeca`.
